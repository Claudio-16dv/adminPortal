...
final class UpdateClientNoAddressesTest extends TestCase
{
    #[DataProvider('providePayloadsWithoutAddresses')]
    public function testUpdateClientWhenAddressesMissingOrEmptyDoesNotCallUpdateAddresses(
        int $id,
    ...
    public static function providePayloadsWithoutAddresses(): array
    {
        $existing = [
