...
final class DeleteClientDeleteFailsTest extends TestCase
{
    public function testDeleteClient_ThrowsWhenDeleteReturnsFalse(): void
    {
        $id = 124;
        ...
        $this->expectExceptionMessage('Não foi possível excluir o cliente.');
